...
browserPromise
    ...
    .then(function () {
        ...
        let emailWillBeTypedPromise = gtab.type("#input-1", "lebivo3531@aramidth.com", { delay: 200 });
        return emailWillBeTypedPromise;
    }).then(function () {
        let passwordWillBeTypedPromise = gtab.type("#input-2", "1999@Avaneeshsingh", { delay: 200 });
